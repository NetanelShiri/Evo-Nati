<%--
    ...
    Author     : blecherl
    This is the login JSP for the online ett application
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <%@page import="ett.utils.*" %>
    <%@ page import="ett.constants.Constants" %>
    <head>
...
<!--        and\or any other scripts you might need to operate the JSP file behind the scene once it arrives to the client-->
    ...
    <body>
        <div class="container">
            ...
            <form method="GET" action="loginShortResponse">
            ...
            <a href="../chatroom/chatroom.html">Click here to enter the ett room</a>
            <br/>
