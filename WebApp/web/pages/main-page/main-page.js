...
const btnsOpenModalreg = document.querySelectorAll('.btn--show-modal-register');
...
btnsOpenModalreg.forEach(btn => btn.addEventListener('click', openModalreg));
