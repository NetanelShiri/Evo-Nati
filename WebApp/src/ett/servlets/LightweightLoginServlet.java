...
import static ett.constants.Constants.USERNAME;
...
public class LightweightLoginServlet extends HttpServlet {
    ...
    private final String FILE_ROOM_URL = "pages/fileroom/fileroom.html";
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        response.getOutputStream().println(FILE_ROOM_URL);
                    }
                }
            }
        } else {
